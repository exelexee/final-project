...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.img_add = tk.PhotoImage(file="C:\\Users\\fedos\\OneDrive\\Рабочий стол\\Итоговый_Проект\\add.png")
        ...
        self.img_upd = tk.PhotoImage(file="C:\\Users\\fedos\\OneDrive\Рабочий стол\\Итоговый_Проект\\change.png")
        ...
        # Кнопка поиска
        self.img_search = tk.PhotoImage(file="C:\\Users\\fedos\\OneDrive\Рабочий стол\\Итоговый_Проект\\search.png")
        ...
        # Кнопка обновления
        self.img_refresh = tk.PhotoImage(file="C:\\Users\\fedos\OneDrive\\Рабочий стол\\Итоговый_Проект\\refresh.png")
        ...
        self.delete_img = tk.PhotoImage(file="C:\\Users\\fedos\\OneDrive\\Рабочий стол\\Итоговый_Проект\\delete.png")
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        self.btn_add.place(x=265, y=180)
